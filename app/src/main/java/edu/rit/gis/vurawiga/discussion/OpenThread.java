...
public class OpenThread extends Activity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (inputValidator()) {
                    ...
                    client.post("http://vurawiga-vwdiscussions.rhcloud.com/newComment", params, new AsyncHttpResponseHandler() {
                        @Override
    ...
    private void Display_Rows() {
        ...
        client.get("http://vurawiga-vwdiscussions.rhcloud.com/getComments/"+intentID, new JsonHttpResponseHandler() {
